...
This model shows us that for every additional 1% of a census tract area covered by parks, its social vulnerability score (measured on a 0 to 1 percentile scale) drops by an average of 0.0046. That is, if one tract has 10% more green space than another, we can expect it to score 4.6 percentile points better on SVI, indicating **fill this in**. 
