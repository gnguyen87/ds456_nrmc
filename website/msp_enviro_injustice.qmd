...
[@cr-map-lst]{pan-to="220px, -300px" scale-by="1.6"} In **higher HOLC** grade neighborhoods with **dense** concentrations of racial covenants, today's land surface temperature is **markedly lower**.
...
[@cr-map-air]{pan-to="250px, -270px" scale-by="1.7"} Neighborhoods with a lot of previous racial covenants, ones that were deemed as **desirable** and **worthy of investment**, tend to have **no** factories planted within its vicinity. In other words, they tend to be exposed to **zero** emissions of PM2.5 from nearyby factories.
